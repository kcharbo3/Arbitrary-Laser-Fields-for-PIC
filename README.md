...
| WAIST_IN_RADIAL            | Only used if spatial shape is PETAL_N_RADIAL. Defines the input waist of each petal in the radial direction.                                      | Float                                                                                                                                                                                                             |
| WAIST_IN_AZIMUTHAL         | Only used if spatial shape is PETAL_N_RADIAL. Defines the input waist of each petal in the azimuthal direction.                                   | Float                                                                                                                                                                                                             |
