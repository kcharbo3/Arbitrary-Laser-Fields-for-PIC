...
| SPATIAL_SHAPE              | Transverse shape of the laser pulse. See Note 1 below for more descriptions.                                                                      | For 3D: LG, LG_RADIAL_CHIRP, GAUSSIAN, RADIAL_CHIRP, LINEAR_CHIRP_Y, LINEAR_CHIRP_Z, PETAL_N<br/> For 2D: LG_2D, LG_RADIAL_CHIRP_2D, GAUSSIAN_2D, CHEVRON_2D, LINEAR_2D |
...
| NUM_PETALS                 | Only used if spatial_shape is PETAL_N. Defines the number of petals to include at the focusing optic entrance. See Note 4.                        | Integer                                                                                                                                                                                  |
...
| GRATING_ANGLE_OF_INCIDENCE | Angle of incidence on the grating first chirp grating. Changing this will change the nonlinearity of the spatial chirp.                                                                                                               | Float           |
